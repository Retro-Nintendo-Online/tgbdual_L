...
{
public:
	dx_renderer(HWND hwnd,HINSTANCE hInst);
	~dx_renderer();
	...
	bool get_mirror(){ return b_mirror; }
...
private:
	...
	key_dat save_key,load_key,auto_key,pause_key;
